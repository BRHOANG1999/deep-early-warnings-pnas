...
# Import EWS data
df_ews_forced = pd.read_csv('C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/data/ews/df_ews_forced.csv')
df_ews_null = pd.read_csv('C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/data/ews/df_ews_null.csv')
 
# Import kendall tau data
df_ktau_forced = pd.read_csv('C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/data/ews/df_ktau_forced.csv')
df_ktau_null = pd.read_csv('C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/data/ews/df_ktau_null.csv')

# Import ML prediction data
df_ml_forced = pd.read_csv('C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/data/ml_preds/parsed/df_ml_forced.csv')
df_ml_null = pd.read_csv('C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/data/ml_preds/parsed/df_ml_null.csv')
...
filepath = 'C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/data/roc/df_bif_pred_counts_{}.csv'.format(
...
# Export ROC data
filepath = 'C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/data/roc/df_roc_seizures_{}.csv'.format(
    'early' if bool_pred_early else 'late')
...
fig.update_layout(
    ...
    width=600,
    height=600,
    title='ROC: seizures transitions'
    )


fig.write_image('C:/Users/Brandon/repositories/deep-early-warnings-pnas/test_empirical/seizure/figures/figs_roc/roc_seizures_{}.png'.format('early' if bool_pred_early else 'late'))
